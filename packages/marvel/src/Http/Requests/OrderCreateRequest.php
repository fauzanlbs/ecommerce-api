...
class OrderCreateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'payment_gateway'  => ['required', Rule::in([PaymentGatewayType::STRIPE, PaymentGatewayType::CASH_ON_DELIVERY, PaymentGatewayType::BNI,
            PaymentGatewayType::BRI,
            PaymentGatewayType::BCA])],
